...
public class BitcoinActivity extends CoinActivity {
//
//    @Override
...
//    }
    ...
    protected String getCoinUrl() {
        return "https://api.binance.com/api/v3/ticker/price?symbol=BTCUSDT"; // URL de Bitcoin
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_bitcoin; // Layout específico para Bitcoin
    }
}
